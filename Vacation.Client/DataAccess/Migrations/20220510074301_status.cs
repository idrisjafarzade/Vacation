        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_AspNetUsers_EmployeeId1",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VacationsApply", x => x.Id);
                    table.ForeignKey(
                        name: "FK_VacationsApply_AspNetUsers_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_VacationsApply_Vacations_VacationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VacationsApply_EmployeeId",
                table: "VacationsApply",
                column: "EmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_VacationsApply_VacationId",
                table: "VacationsApply",
                column: "VacationId");
        }
